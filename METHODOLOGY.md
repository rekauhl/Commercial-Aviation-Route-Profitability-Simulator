...
$$ \text{Block Hours} = \frac{\text{Distance}_{km}}{840} + 0.35 $$
...
$$ \text{Fee} = \frac{\text{Distance}_{km}}{100} \times \sqrt{\frac{\text{MTOW}_{tonnes}}{50}} \times \text{Blended Unit Rate} $$

$$ \text{Blended Unit Rate} = \frac{\text{Origin Country Rate} + \text{Destination Country Rate}}{2} $$
...
$$ 
\begin{align*}
\text{Mass fee} &=  \text{€}2.50 \times \lceil \text{MTOW}_{tonnes} \rceil \quad (\text{per movement}) \\
 \text{Passenger fee} &= \text{€}28.10 / \text{departing passenger} \\
  &= \text{€}1.79 \left(\text{\S}1.2.4\right) + \text{€}24.56 \left(\text{\S}1.3.2\right) + \text{€}1.63 \left(\text{\S}1.4\right) + \text{€}0.12 \left(\text{\S}1.6.2\right) 
\end{align*}
$$
